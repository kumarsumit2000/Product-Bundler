...
// Slim style panel for bundles — mirrors SimpleQbStylePanel so the merchant
// experience stays consistent across widget types. Exposes layout, colors
// (cards / borders / text / button / savings badge), shape, and font sizes.
export function SimpleBundleStylePanel({ values, onChange }: Props) {
  return (
    <Card>
      <BlockStack gap="300">
        ...
        <FormLayout>
          ...
          <FormLayout.Group>
            ...
            />
            <ColorSwatchPicker
              label="Selected card bg (mix & match)"
